...
namespace WheelchairDriver
{
	...
	public:
		...
		bool AddWheelchairController(std::shared_ptr<VRController> wheelchairController);

		std::shared_ptr<VRController> GetWheelchairController();
	...
	private:
		std::shared_ptr<VRController> wheelchairController_;
